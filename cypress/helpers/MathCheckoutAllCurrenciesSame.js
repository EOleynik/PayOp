    ...
    checkStrategyMathRUB(payAmount) {
        cy.request({
            ...
            expect(response.body).property('data').to.not.be.oneOf([null, ""]);
                ...
                if(strategy === 1){
                    strategyAll(payAmount, fixedCommission, percentCommission, strategy, payerPart, userPart);
                } else {
                    strategyMax(payAmount, fixedCommission, percentCommission, strategy, payerPart, userPart);
                }
        })}
...
function strategyAll(payAmount, fixedCommission, percentCommission, strategy, payerPart, userPart){
...
function strategyMax(payAmount, fixedCommission, percentCommission, strategy, payerPart, userPart){
    if (payerPart == 0) {
