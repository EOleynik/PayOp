...
function createAndCheckRefund() {
    ...
    transactionsPage.getCreatePartialRefundButton().click({force: true});
    transactionsPage.getFillRefundValue("50.22");
    transactionsPage.getConfirmPartialRefundButton().click({force: true});
